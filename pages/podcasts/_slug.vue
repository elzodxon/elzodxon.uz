    ...
    <div v-else class="podcast-single-content mt-8">
      ...
      <div class="podcast-single-play my-20">
        ...
        <div class="podcast-playground items-center flex bg-black px-4 py-2 rounded-md my-8 w-11/12">
          <iframe v-if="isPlaying" class="podcast-playground-video rounded-xl" :src="podcast.podcast_link" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          <div class="mx-4">
            <h5 class="podcast-play-channel-title text-[14px] text-gray-500 font-semibold  my-4 ">Elzodxon Sharofaddinov • Episode 32 </h5>
            <h3 class="podcast-play-title text-xl text-white font-semibold mb-4">{{ podcast.title }}</h3>
            <div class="flex my-4">
              <i class="bi bi-play-circle-fill text-5xl text-white cursor-pointer" @click="playPodcast"></i>
